...
public class ProvinceDAO implements Serializable {
    ...
    public int[] insert(List<Area> list) throws ClassNotFoundException, SQLException {
        Connection con = null;
        ...
        try {
            ...
            if (con != null) {
                ...
                stmt = con.prepareStatement(SQLStatement.INSERT_PROVINCE);
